...
//         <p className="text-blue-600 hover:underline">Your Coins</p>
//       </Link>
...
//               {profile.birthDate && profile.showBirthDate && (
//                 <div>
...
//               {profile.lineContact && (
//                 <div>
//                   <p className="text-sm text-gray-500">Line Contact</p>
//                   <a
//                     href={profile.lineContact}
//                     target="_blank"
//                     rel="noopener noreferrer"
...
//                         )}
//                         {doc.type && (
//                           <p>Type: {doc.type.split("/")[1]?.toUpperCase()}</p>
//                         )}
//                       </div>
//                     </div>
//                   ))}
