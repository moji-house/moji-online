  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (formData.coAgentCommission) {
        formDataToSend.append(
          "coAgentCommission",
          formData.coAgentCommission.toString()
        );
      }
          ...
          <div className="col-span-2">
            ...
            {previewImages.length > 0 && (
              <div className="mt-4 grid grid-cols-2 md:grid-cols-5 gap-4">
                {previewImages.map((src: any, index) => (
          ...
          <div className="col-span-2">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                min="0"
                max="100"
                className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.coAgentCommission
                    ? "border-red-500"
                    : "border-gray-300"
                  }`}
              />
